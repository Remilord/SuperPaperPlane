...
public class Bonus extends GameObject {
	...
	public Bonus(int x,int y) {
		...
		this.bonusTras = Niveau.loadBufferedImage("D:/Dossier perso/Programmation/Java/SuperPaperPlane/image/bonus/BonusTras.png");
		this.bonusSpeed = Niveau.loadBufferedImage("D:/Dossier perso/Programmation/Java/SuperPaperPlane/image/bonus/BonusSpeed.png");
		this.bonusmini = Niveau.loadBufferedImage("D:/Dossier perso/Programmation/Java/SuperPaperPlane/image/bonus/Bonusmini.png");
	...
	public void resetPosition() {
		this.setPositionY(rand.nextInt(2001)+3000);
        this.setPositionX(rand.nextInt(700)+20);
	}
